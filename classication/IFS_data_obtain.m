...
%%%%%%Obtain the peak's (in variable 'peak') z-score transformed IFS (before GC (peak_type==1) or after GC bias correction (peak_type==2)) for the sample 'path_name'
...
seed=unique(peak(:,1));
%%If some chromosomes don't have peak, don't calculate IFS in these
%%chromosomes
chr_flag=zeros(22,1);
chr_flag(seed,1)=1;
